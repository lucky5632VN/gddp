...
export function HeritageCard({ item }: HeritageCardProps) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group relative bg-slate-900/50 border border-white/10 rounded-[2.5rem] overflow-hidden hover:border-heritage-turquoise/40 transition-all duration-500 shadow-xl"
    >
      {/* Background Glow */}
      ...
      <div className="relative h-64 w-full overflow-hidden">
        ...
        {item.isNationalHeritage && (
          <div className="absolute top-6 left-6 z-10">
            <div className="flex items-center space-x-2 bg-national-gold/90 backdrop-blur-md text-slate-950 px-4 py-1.5 rounded-full shadow-lg">
        ...
        <div className="absolute bottom-6 left-6 z-10">
            <div className="flex items-center space-x-2 bg-slate-950/60 backdrop-blur-md text-heritage-turquoise px-4 py-1.5 rounded-full border border-heritage-turquoise/30">
      ...
      <div className="p-10 space-y-4 relative z-10">
        <h3 className="text-2xl font-heading font-bold text-white group-hover:text-heritage-turquoise transition-colors underline decoration-white/5 underline-offset-8 group-hover:decoration-heritage-turquoise/30">
          {item.name}
        </h3>
