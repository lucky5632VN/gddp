...
export function AboutSection() {
  return (
    <section className="py-24 px-6 bg-slate-950 font-sans border-b border-white/5 relative overflow-hidden">
      {/* Subtle Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900/40 via-slate-950 to-slate-950 opacity-40" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="text-slate-300 text-lg leading-relaxed space-y-6 font-serif">
              <p>
                Nghệ An là trung tâm khu vực Bắc Trung Bộ, nơi hội tụ địa hình phức tạp và đa dạng nhất. Với tổng diện tích đất nông nghiệp lên tới <strong className="text-white">1.249.176,1 ha</strong> và quỹ đất phi nông nghiệp <strong className="text-white">129.171,6 ha</strong>, đây là nền tảng của một nền kinh tế bám rễ sâu vào sinh tồn tự nhiên.
              </p>
              <p>
                Khí hậu nhiệt đới gió mùa khắc nghiệt với độ ẩm duy trì ở mức <strong className="text-white">40%</strong>, áp suất <strong className="text-white">1005 hPa</strong> và điểm ngưng tụ <strong className="text-white">13°C</strong>. Sự tàn phá của <strong className="text-heritage-turquoise font-bold">Gió Lào</strong> và bão lũ đã tôi luyện nên ý chí kiên cường và bản sắc văn hóa kiên trung, bất khuất của cư dân xứ Nghệ.
              </p>
            ...
            <div className="grid grid-cols-2 gap-6 mt-12">
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                    ...
                    <div className="text-[10px] text-slate-500 uppercase tracking-widest mb-1">Đất nông nghiệp</div>
                    <div className="text-xl font-bold text-white">1.249.176 ha</div>
                </div>
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                    <Wind className="text-heritage-turquoise mb-4" />
                    <div className="text-[10px] text-slate-500 uppercase tracking-widest mb-1">Áp suất khí quyển</div>
                    <div className="text-xl font-bold text-white">1005 hPa</div>
                </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative group">
                ...
                <div className="relative bg-slate-900 border border-white/10 p-10 rounded-3xl backdrop-blur-sm">
                    ...
                    <div className="space-y-4">
                        <div className="flex border-b border-white/5 pb-4">
                            ...
                            <div className="text-sm text-slate-400">Tính ấm nóng giúp cơ thể thích ứng với thời tiết cực đoan miền Trung.</div>
                        </div>
                        <div className="flex border-b border-white/5 pb-4">
                            <div className="w-24 text-heritage-turquoise font-bold">Nhút</div>
                            <div className="text-sm text-slate-400">Mít non muối mặn – biểu tượng của tính tằn tiện và sáng tạo trong gian khó.</div>
                        </div>
                        <div className="flex">
                            <div className="w-24 text-heritage-turquoise font-bold">Rươi</div>
                            <div className="text-sm text-slate-400">"Quà của đất" Hưng Nguyên, kết tinh từ nhịp điệu sinh thái đất sình lầy.</div>
                        </div>
                    </div>
                </div>
            </div>

            <div className="p-8 border-l-2 border-national-gold bg-white/[0.02] backdrop-blur-sm">
