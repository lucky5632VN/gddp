...
export function BocMoTimeline() {
  ...
  return (
    <section className="py-24 px-4 bg-background font-sans border-t border-slate-100">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl text-slate-900 font-heading font-bold mb-6">
            Lễ hội Bốc Mó <br />
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-1/2 -translate-x-1/2 w-1 h-full bg-slate-100 rounded-full" />
          ...
          <div className="space-y-16">
            {bocMo.timeline.map((step, index) => (
              ...
              >
                ...
                {/* Dot */}
                <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-festival-orange shadow-lg z-10 border-4 border-white" />

                <div className="w-full md:w-5/12 p-8 bg-white border border-slate-100 rounded-2xl hover:border-festival-orange/40 transition-all shadow-md hover:shadow-xl">
